...
adjacent_seats = SeatApi.get_adjacent_seats(requestor.seat)
...
selected_seat1 = PromptApi.prompt_student_choice(empty_seats, "Target Student 1 Seat")
...
selected_seat2 = PromptApi.prompt_student_choice(empty_seats, "Target Student 2 Seat")
